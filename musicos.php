...
<html class="no-js" lang="fr">
  <head>
    ...
    <meta name="Description" content="Les Bamboo Suckers">
    <meta name="Keywords" content="Bamboo Suckers Musique Jazz Band Coursan Membres">
...
<!--les-suckers -->
<div class="les-suckers">
      <span class="sam">
          <img src="images/Sami.png">
            </br></br>
          <p id="yayachoucroute">Sami:Baryton</p>
      </span>
      <span class="lolo">
          <img src="images/Sami.png">
            </br></br>
      ...
      <span class="Ben">
          ...
          <p>Ben: Trombone, Trompette, Souba</p></br><h6>et chef incontesté de la panditude</h6>
      </span>
</div>
<!-- Pied de page -->
<footer class="footer">
