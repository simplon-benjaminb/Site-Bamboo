...
<html class="no-js" lang="fr">
  <head>
    ...
    <meta name="Description" content="Contacts Bamboo Suckers">
    <meta name="Keywords" content="Bamboo Suckers Musique Jazz Band Coursan contact">
...
<!-- contact -->
  ...
  <div class="contactpage">
        	...
        	<h3>Voulez-vous nous contacter professionnellement ?</h3></br></br>
          </br></br></br>
            <div class="contactpagebtn">
                <a class="bigbtn anim yescontact" href="formumu.php">Non</a>
                <a class="bigbtn anim nocontact" href="#">Oui</a>
                <div class="clear"></div>
            </div>
            <div class="contactchat" id="contactchat">
              </br></br></br></br></br>
              <h3>Pour nous contacter professionnellement veuillez envoyer un mail à:</h3>
              </br></br></br>
              <iframe src="me.php" frameborder="0" scrolling="no" height="50" width="150" class="chat"></iframe>
            </div>
  </div>
    <!-- script choix du contact -->
    <script>
         $(function() {
