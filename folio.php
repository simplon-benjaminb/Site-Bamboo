...
body {margin:0; padding:0; background:#333 url(imgs/sw_page_bg.png); font-family:Helvetica, Arial, sans-serif; font-size:16px;}
/* custom fonts */
@font-face {
...
#toolbar{display:inline-block; padding:4px 15px; margin:20px 15px; background:#262626 url(imgs/sw_btn_bg.png) repeat-x; -moz-border-radius:8px; -khtml-border-radius:8px; -webkit-border-radius:8px; border-radius:8px; font-family:graublauweb-webfont, Helvetica, Arial, sans-serif; font-size:12px; color:#fff; cursor:pointer;}
#outer_container{position:relative; margin:0; width:700px; padding:0; z-index:2; background:url(imgs/empty.gif);} /* fucking IE needs a background value to understand hover area */
#customScrollBox{position:relative; background:url(imgs/sw_l_bg.png) repeat-y;}
#customScrollBox .container{position:relative; width:585px; top:0; float:left;}
#customScrollBox .content{clear:both;}
#customScrollBox .content h1{padding:5px; margin:10px; color:#ffff00; font-family:"Lobster",cursive;; font-size:48px;}
...
#customScrollBox a.thumb_link .selected{position:absolute; top:0; left:0; width:145px; height:91px; background:url(imgs/sw_thumb_selected.png) no-repeat; display:none;}
#arrow_indicator{position:absolute; cursor:pointer; width:50px; padding:10px; top:50%; margin-top:-25px; left:20px; background:url(imgs/sw_transparent_black_bg.png); -moz-border-radius:5px; -khtml-border-radius:5px; -webkit-border-radius:5px; border-radius:5px; display:none;}
#nextimage_tip{position:fixed; z-index:1; padding:0 20px; line-height:40px; color:#fff; height:40px; top:50%; margin-top:-20px; right:20px; background:url(imgs/sw_transparent_black_bg.png); -moz-border-radius:5px; -khtml-border-radius:5px; -webkit-border-radius:5px; border-radius:5px; display:none; font-family:graublauweb-webfont, Helvetica, Arial, sans-serif;}
...
<link href='http://www.dafont.com/css?family=yorkwhiteletter' rel='stylesheet' type='text/css'>
...
<div id="customScrollBox">
	<div class="container">
    	<div class="content"><div class="folioti">
    	  <h1>Photos Bamboo Suckers <br /></h1>
    	</div>
            <p>Nous avons peu de photo pour le moment mais ça va venir!</p>
...
<div id="bg">
	...
	<div id="preloader"><img src="imgs/ajax-loader_dark.gif" width="32" height="32" align="absmiddle" />LOADING...</div>
    <div id="arrow_indicator" title="Open images thumbnails"><img src="imgs/sw_arrow_indicator.png" width="50" height="50" alt="Open images thumbnails" /></div>
...
var images=["imgs/ajax-loader_dark.gif","round_custom_scrollbar_bg_over.png"];
